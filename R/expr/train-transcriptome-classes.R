...
## Project: FRONTIER
## Script purpose: 
## Use L2-regularized logistic regression to train a set of Illumina methylation probes to predict 
## transcriptional subtypes (Verhaak 2010, 2013 revision or Wang 2017) 
## Date: June 14, 2018
